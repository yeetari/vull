...
// public:
//     explicit OneOf(T collection) : m_collection(collection) {}

//     void describe(Message &message) const {
//         message.append_text("one of ");
//         message.append_value(m_collection);
//     }

//     void describe_mismatch(Message &message, const auto &) const {
//         message.append_text("not one of ");
//         message.append_value(m_collection);
//     }

//     bool matches(const auto &object) const { return m_collection.contains(object); }
// };

// template <typename T>
// constexpr auto one_of(const T &collection) {
//     return OneOf<const T &>(collection);
// }
...
public:
    ...
    bool matches(const auto &collection) const {
