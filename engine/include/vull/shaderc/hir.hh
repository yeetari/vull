...
public:
    explicit BuiltinExpr(BuiltinFunction function) : Expr(NodeKind::BuiltinExpr), m_function(function) {}
...
class BindingVariable : public Expr {
    uint32_t m_descriptor_set;
    uint32_t m_binding;
    
public:
    BindingVariable() : Expr(NodeKind::BindingVariable) {}
};
