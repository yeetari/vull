...
public:
    ...
    void vkGetPhysicalDeviceFeatures2KHR(VkPhysicalDeviceFeatures2 *pFeatures) const; // NOLINT
    ...
    void vkGetPhysicalDeviceFormatProperties2KHR(VkFormat format, VkFormatProperties2 *pFormatProperties) const; // NOLINT
    ...
    VkResult vkGetPhysicalDeviceImageFormatProperties2KHR(const VkPhysicalDeviceImageFormatInfo2 *pImageFormatInfo, VkImageFormatProperties2 *pImageFormatProperties) const; // NOLINT
    ...
    void vkGetPhysicalDeviceMemoryProperties2KHR(VkPhysicalDeviceMemoryProperties2 *pMemoryProperties) const; // NOLINT
    ...
    void vkGetPhysicalDeviceProperties2KHR(VkPhysicalDeviceProperties2 *pProperties) const; // NOLINT
    ...
    void vkGetPhysicalDeviceQueueFamilyProperties2KHR(uint32_t *pQueueFamilyPropertyCount, VkQueueFamilyProperties2 *pQueueFamilyProperties) const; // NOLINT
    ...
    void vkGetPhysicalDeviceSparseImageFormatProperties2KHR(const VkPhysicalDeviceSparseImageFormatInfo2 *pFormatInfo, uint32_t *pPropertyCount, VkSparseImageFormatProperties2 *pProperties) const; // NOLINT
