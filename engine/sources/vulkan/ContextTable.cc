// File generated by tools/gen_vk.py on 25-01-2022 22:22:54
...
void ContextTable::load_instance(PFN_vkGetInstanceProcAddr vkGetInstanceProcAddr) {
    ...
    m_vkGetPhysicalDeviceFeatures2KHR = reinterpret_cast<PFN_vkGetPhysicalDeviceFeatures2KHR>(vkGetInstanceProcAddr(m_instance, "vkGetPhysicalDeviceFeatures2KHR"));
    ...
    m_vkGetPhysicalDeviceFormatProperties2KHR = reinterpret_cast<PFN_vkGetPhysicalDeviceFormatProperties2KHR>(vkGetInstanceProcAddr(m_instance, "vkGetPhysicalDeviceFormatProperties2KHR"));
    ...
    m_vkGetPhysicalDeviceImageFormatProperties2KHR = reinterpret_cast<PFN_vkGetPhysicalDeviceImageFormatProperties2KHR>(vkGetInstanceProcAddr(m_instance, "vkGetPhysicalDeviceImageFormatProperties2KHR"));
    ...
    m_vkGetPhysicalDeviceMemoryProperties2KHR = reinterpret_cast<PFN_vkGetPhysicalDeviceMemoryProperties2KHR>(vkGetInstanceProcAddr(m_instance, "vkGetPhysicalDeviceMemoryProperties2KHR"));
    ...
    m_vkGetPhysicalDeviceProperties2KHR = reinterpret_cast<PFN_vkGetPhysicalDeviceProperties2KHR>(vkGetInstanceProcAddr(m_instance, "vkGetPhysicalDeviceProperties2KHR"));
    ...
    m_vkGetPhysicalDeviceQueueFamilyProperties2KHR = reinterpret_cast<PFN_vkGetPhysicalDeviceQueueFamilyProperties2KHR>(vkGetInstanceProcAddr(m_instance, "vkGetPhysicalDeviceQueueFamilyProperties2KHR"));
    ...
    m_vkGetPhysicalDeviceSparseImageFormatProperties2KHR = reinterpret_cast<PFN_vkGetPhysicalDeviceSparseImageFormatProperties2KHR>(vkGetInstanceProcAddr(m_instance, "vkGetPhysicalDeviceSparseImageFormatProperties2KHR"));
...
VkResult ContextTable::vkAcquireNextImage2KHR(const VkAcquireNextImageInfoKHR *pAcquireInfo, uint32_t *pImageIndex) const {
    return m_vkAcquireNextImage2KHR(m_device, pAcquireInfo, pImageIndex);
}

VkResult ContextTable::vkAcquireNextImageKHR(VkSwapchainKHR swapchain, uint64_t timeout, VkSemaphore semaphore, VkFence fence, uint32_t *pImageIndex) const {
    return m_vkAcquireNextImageKHR(m_device, swapchain, timeout, semaphore, fence, pImageIndex);
}

VkResult ContextTable::vkAllocateCommandBuffers(const VkCommandBufferAllocateInfo *pAllocateInfo, VkCommandBuffer *pCommandBuffers) const {
    return m_vkAllocateCommandBuffers(m_device, pAllocateInfo, pCommandBuffers);
}

VkResult ContextTable::vkAllocateDescriptorSets(const VkDescriptorSetAllocateInfo *pAllocateInfo, VkDescriptorSet *pDescriptorSets) const {
    return m_vkAllocateDescriptorSets(m_device, pAllocateInfo, pDescriptorSets);
}

VkResult ContextTable::vkAllocateMemory(const VkMemoryAllocateInfo *pAllocateInfo, VkDeviceMemory *pMemory) const {
    return m_vkAllocateMemory(m_device, pAllocateInfo, nullptr, pMemory);
}

VkResult ContextTable::vkBeginCommandBuffer(VkCommandBuffer commandBuffer, const VkCommandBufferBeginInfo *pBeginInfo) const {
    return m_vkBeginCommandBuffer(commandBuffer, pBeginInfo);
}

VkResult ContextTable::vkBindBufferMemory(VkBuffer buffer, VkDeviceMemory memory, VkDeviceSize memoryOffset) const {
    return m_vkBindBufferMemory(m_device, buffer, memory, memoryOffset);
}

VkResult ContextTable::vkBindBufferMemory2(uint32_t bindInfoCount, const VkBindBufferMemoryInfo *pBindInfos) const {
    return m_vkBindBufferMemory2(m_device, bindInfoCount, pBindInfos);
}

VkResult ContextTable::vkBindImageMemory(VkImage image, VkDeviceMemory memory, VkDeviceSize memoryOffset) const {
    return m_vkBindImageMemory(m_device, image, memory, memoryOffset);
}

VkResult ContextTable::vkBindImageMemory2(uint32_t bindInfoCount, const VkBindImageMemoryInfo *pBindInfos) const {
    return m_vkBindImageMemory2(m_device, bindInfoCount, pBindInfos);
}

void ContextTable::vkCmdBeginQuery(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query, VkQueryControlFlags flags) const {
    return m_vkCmdBeginQuery(commandBuffer, queryPool, query, flags);
}

void ContextTable::vkCmdBeginRenderPass(VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo *pRenderPassBegin, VkSubpassContents contents) const {
    return m_vkCmdBeginRenderPass(commandBuffer, pRenderPassBegin, contents);
}

void ContextTable::vkCmdBeginRenderPass2(VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo *pRenderPassBegin, const VkSubpassBeginInfo *pSubpassBeginInfo) const {
    return m_vkCmdBeginRenderPass2(commandBuffer, pRenderPassBegin, pSubpassBeginInfo);
}

void ContextTable::vkCmdBeginRenderingKHR(VkCommandBuffer commandBuffer, const VkRenderingInfoKHR *pRenderingInfo) const {
    return m_vkCmdBeginRenderingKHR(commandBuffer, pRenderingInfo);
}

void ContextTable::vkCmdBindDescriptorSets(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32_t firstSet, uint32_t descriptorSetCount, const VkDescriptorSet *pDescriptorSets, uint32_t dynamicOffsetCount, const uint32_t *pDynamicOffsets) const {
...
void ContextTable::vkCmdBindIndexBuffer(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkIndexType indexType) const {
    return m_vkCmdBindIndexBuffer(commandBuffer, buffer, offset, indexType);
}

void ContextTable::vkCmdBindPipeline(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline) const {
    return m_vkCmdBindPipeline(commandBuffer, pipelineBindPoint, pipeline);
}

void ContextTable::vkCmdBindVertexBuffers(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBuffer *pBuffers, const VkDeviceSize *pOffsets) const {
    return m_vkCmdBindVertexBuffers(commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets);
}

void ContextTable::vkCmdBlitImage(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkImageBlit *pRegions, VkFilter filter) const {
    return m_vkCmdBlitImage(commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regionCount, pRegions, filter);
}

void ContextTable::vkCmdClearAttachments(VkCommandBuffer commandBuffer, uint32_t attachmentCount, const VkClearAttachment *pAttachments, uint32_t rectCount, const VkClearRect *pRects) const {
    return m_vkCmdClearAttachments(commandBuffer, attachmentCount, pAttachments, rectCount, pRects);
}

void ContextTable::vkCmdClearColorImage(VkCommandBuffer commandBuffer, VkImage image, VkImageLayout imageLayout, const VkClearColorValue *pColor, uint32_t rangeCount, const VkImageSubresourceRange *pRanges) const {
    return m_vkCmdClearColorImage(commandBuffer, image, imageLayout, pColor, rangeCount, pRanges);
}

void ContextTable::vkCmdClearDepthStencilImage(VkCommandBuffer commandBuffer, VkImage image, VkImageLayout imageLayout, const VkClearDepthStencilValue *pDepthStencil, uint32_t rangeCount, const VkImageSubresourceRange *pRanges) const {
    return m_vkCmdClearDepthStencilImage(commandBuffer, image, imageLayout, pDepthStencil, rangeCount, pRanges);
}

void ContextTable::vkCmdCopyBuffer(VkCommandBuffer commandBuffer, VkBuffer srcBuffer, VkBuffer dstBuffer, uint32_t regionCount, const VkBufferCopy *pRegions) const {
    return m_vkCmdCopyBuffer(commandBuffer, srcBuffer, dstBuffer, regionCount, pRegions);
}

void ContextTable::vkCmdCopyBufferToImage(VkCommandBuffer commandBuffer, VkBuffer srcBuffer, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkBufferImageCopy *pRegions) const {
    return m_vkCmdCopyBufferToImage(commandBuffer, srcBuffer, dstImage, dstImageLayout, regionCount, pRegions);
}

void ContextTable::vkCmdCopyImage(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkImageCopy *pRegions) const {
    return m_vkCmdCopyImage(commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regionCount, pRegions);
}

void ContextTable::vkCmdCopyImageToBuffer(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkBuffer dstBuffer, uint32_t regionCount, const VkBufferImageCopy *pRegions) const {
    return m_vkCmdCopyImageToBuffer(commandBuffer, srcImage, srcImageLayout, dstBuffer, regionCount, pRegions);
}

void ContextTable::vkCmdCopyQueryPoolResults(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize stride, VkQueryResultFlags flags) const {
    return m_vkCmdCopyQueryPoolResults(commandBuffer, queryPool, firstQuery, queryCount, dstBuffer, dstOffset, stride, flags);
}

void ContextTable::vkCmdDispatch(VkCommandBuffer commandBuffer, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ) const {
    return m_vkCmdDispatch(commandBuffer, groupCountX, groupCountY, groupCountZ);
}

void ContextTable::vkCmdDispatchBase(VkCommandBuffer commandBuffer, uint32_t baseGroupX, uint32_t baseGroupY, uint32_t baseGroupZ, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ) const {
    return m_vkCmdDispatchBase(commandBuffer, baseGroupX, baseGroupY, baseGroupZ, groupCountX, groupCountY, groupCountZ);
}

void ContextTable::vkCmdDispatchIndirect(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset) const {
    return m_vkCmdDispatchIndirect(commandBuffer, buffer, offset);
}

void ContextTable::vkCmdDraw(VkCommandBuffer commandBuffer, uint32_t vertexCount, uint32_t instanceCount, uint32_t firstVertex, uint32_t firstInstance) const {
    return m_vkCmdDraw(commandBuffer, vertexCount, instanceCount, firstVertex, firstInstance);
}

void ContextTable::vkCmdDrawIndexed(VkCommandBuffer commandBuffer, uint32_t indexCount, uint32_t instanceCount, uint32_t firstIndex, int32_t vertexOffset, uint32_t firstInstance) const {
    return m_vkCmdDrawIndexed(commandBuffer, indexCount, instanceCount, firstIndex, vertexOffset, firstInstance);
}

void ContextTable::vkCmdDrawIndexedIndirect(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t drawCount, uint32_t stride) const {
    return m_vkCmdDrawIndexedIndirect(commandBuffer, buffer, offset, drawCount, stride);
}

void ContextTable::vkCmdDrawIndexedIndirectCount(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) const {
    return m_vkCmdDrawIndexedIndirectCount(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
}

void ContextTable::vkCmdDrawIndirect(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t drawCount, uint32_t stride) const {
    return m_vkCmdDrawIndirect(commandBuffer, buffer, offset, drawCount, stride);
}

void ContextTable::vkCmdDrawIndirectCount(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) const {
    return m_vkCmdDrawIndirectCount(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
}

void ContextTable::vkCmdEndQuery(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query) const {
    return m_vkCmdEndQuery(commandBuffer, queryPool, query);
}

void ContextTable::vkCmdEndRenderPass(VkCommandBuffer commandBuffer) const {
    return m_vkCmdEndRenderPass(commandBuffer);
}

void ContextTable::vkCmdEndRenderPass2(VkCommandBuffer commandBuffer, const VkSubpassEndInfo *pSubpassEndInfo) const {
    return m_vkCmdEndRenderPass2(commandBuffer, pSubpassEndInfo);
}

void ContextTable::vkCmdEndRenderingKHR(VkCommandBuffer commandBuffer) const {
    return m_vkCmdEndRenderingKHR(commandBuffer);
}

void ContextTable::vkCmdExecuteCommands(VkCommandBuffer commandBuffer, uint32_t commandBufferCount, const VkCommandBuffer *pCommandBuffers) const {
    return m_vkCmdExecuteCommands(commandBuffer, commandBufferCount, pCommandBuffers);
}

void ContextTable::vkCmdFillBuffer(VkCommandBuffer commandBuffer, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize size, uint32_t data) const {
    return m_vkCmdFillBuffer(commandBuffer, dstBuffer, dstOffset, size, data);
}

void ContextTable::vkCmdNextSubpass(VkCommandBuffer commandBuffer, VkSubpassContents contents) const {
    return m_vkCmdNextSubpass(commandBuffer, contents);
}

void ContextTable::vkCmdNextSubpass2(VkCommandBuffer commandBuffer, const VkSubpassBeginInfo *pSubpassBeginInfo, const VkSubpassEndInfo *pSubpassEndInfo) const {
    return m_vkCmdNextSubpass2(commandBuffer, pSubpassBeginInfo, pSubpassEndInfo);
}

void ContextTable::vkCmdPipelineBarrier(VkCommandBuffer commandBuffer, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask, VkDependencyFlags dependencyFlags, uint32_t memoryBarrierCount, const VkMemoryBarrier *pMemoryBarriers, uint32_t bufferMemoryBarrierCount, const VkBufferMemoryBarrier *pBufferMemoryBarriers, uint32_t imageMemoryBarrierCount, const VkImageMemoryBarrier *pImageMemoryBarriers) const {
...
void ContextTable::vkCmdPushConstants(VkCommandBuffer commandBuffer, VkPipelineLayout layout, VkShaderStageFlags stageFlags, uint32_t offset, uint32_t size, const void *pValues) const {
    return m_vkCmdPushConstants(commandBuffer, layout, stageFlags, offset, size, pValues);
}

void ContextTable::vkCmdResetEvent(VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags stageMask) const {
    return m_vkCmdResetEvent(commandBuffer, event, stageMask);
}

void ContextTable::vkCmdResetQueryPool(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount) const {
    return m_vkCmdResetQueryPool(commandBuffer, queryPool, firstQuery, queryCount);
}

void ContextTable::vkCmdResolveImage(VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkImageResolve *pRegions) const {
    return m_vkCmdResolveImage(commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regionCount, pRegions);
}

void ContextTable::vkCmdSetBlendConstants(VkCommandBuffer commandBuffer, const float blendConstants [4]) const {
    return m_vkCmdSetBlendConstants(commandBuffer, blendConstants);
}

void ContextTable::vkCmdSetDepthBias(VkCommandBuffer commandBuffer, float depthBiasConstantFactor, float depthBiasClamp, float depthBiasSlopeFactor) const {
    return m_vkCmdSetDepthBias(commandBuffer, depthBiasConstantFactor, depthBiasClamp, depthBiasSlopeFactor);
}

void ContextTable::vkCmdSetDepthBounds(VkCommandBuffer commandBuffer, float minDepthBounds, float maxDepthBounds) const {
    return m_vkCmdSetDepthBounds(commandBuffer, minDepthBounds, maxDepthBounds);
}

void ContextTable::vkCmdSetDeviceMask(VkCommandBuffer commandBuffer, uint32_t deviceMask) const {
    return m_vkCmdSetDeviceMask(commandBuffer, deviceMask);
}

void ContextTable::vkCmdSetEvent(VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags stageMask) const {
    return m_vkCmdSetEvent(commandBuffer, event, stageMask);
}

void ContextTable::vkCmdSetLineWidth(VkCommandBuffer commandBuffer, float lineWidth) const {
    return m_vkCmdSetLineWidth(commandBuffer, lineWidth);
}

void ContextTable::vkCmdSetScissor(VkCommandBuffer commandBuffer, uint32_t firstScissor, uint32_t scissorCount, const VkRect2D *pScissors) const {
    return m_vkCmdSetScissor(commandBuffer, firstScissor, scissorCount, pScissors);
}

void ContextTable::vkCmdSetStencilCompareMask(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, uint32_t compareMask) const {
    return m_vkCmdSetStencilCompareMask(commandBuffer, faceMask, compareMask);
}

void ContextTable::vkCmdSetStencilReference(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, uint32_t reference) const {
    return m_vkCmdSetStencilReference(commandBuffer, faceMask, reference);
}

void ContextTable::vkCmdSetStencilWriteMask(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, uint32_t writeMask) const {
    return m_vkCmdSetStencilWriteMask(commandBuffer, faceMask, writeMask);
}

void ContextTable::vkCmdSetViewport(VkCommandBuffer commandBuffer, uint32_t firstViewport, uint32_t viewportCount, const VkViewport *pViewports) const {
    return m_vkCmdSetViewport(commandBuffer, firstViewport, viewportCount, pViewports);
}

void ContextTable::vkCmdUpdateBuffer(VkCommandBuffer commandBuffer, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize dataSize, const void *pData) const {
    return m_vkCmdUpdateBuffer(commandBuffer, dstBuffer, dstOffset, dataSize, pData);
}

void ContextTable::vkCmdWaitEvents(VkCommandBuffer commandBuffer, uint32_t eventCount, const VkEvent *pEvents, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask, uint32_t memoryBarrierCount, const VkMemoryBarrier *pMemoryBarriers, uint32_t bufferMemoryBarrierCount, const VkBufferMemoryBarrier *pBufferMemoryBarriers, uint32_t imageMemoryBarrierCount, const VkImageMemoryBarrier *pImageMemoryBarriers) const {
...
void ContextTable::vkCmdWriteTimestamp(VkCommandBuffer commandBuffer, VkPipelineStageFlagBits pipelineStage, VkQueryPool queryPool, uint32_t query) const {
    return m_vkCmdWriteTimestamp(commandBuffer, pipelineStage, queryPool, query);
}

VkResult ContextTable::vkCreateBuffer(const VkBufferCreateInfo *pCreateInfo, VkBuffer *pBuffer) const {
    return m_vkCreateBuffer(m_device, pCreateInfo, nullptr, pBuffer);
}

VkResult ContextTable::vkCreateBufferView(const VkBufferViewCreateInfo *pCreateInfo, VkBufferView *pView) const {
    return m_vkCreateBufferView(m_device, pCreateInfo, nullptr, pView);
}

VkResult ContextTable::vkCreateCommandPool(const VkCommandPoolCreateInfo *pCreateInfo, VkCommandPool *pCommandPool) const {
    return m_vkCreateCommandPool(m_device, pCreateInfo, nullptr, pCommandPool);
}

VkResult ContextTable::vkCreateComputePipelines(VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkComputePipelineCreateInfo *pCreateInfos, VkPipeline *pPipelines) const {
    return m_vkCreateComputePipelines(m_device, pipelineCache, createInfoCount, pCreateInfos, nullptr, pPipelines);
}

VkResult ContextTable::vkCreateDescriptorPool(const VkDescriptorPoolCreateInfo *pCreateInfo, VkDescriptorPool *pDescriptorPool) const {
    return m_vkCreateDescriptorPool(m_device, pCreateInfo, nullptr, pDescriptorPool);
}

VkResult ContextTable::vkCreateDescriptorSetLayout(const VkDescriptorSetLayoutCreateInfo *pCreateInfo, VkDescriptorSetLayout *pSetLayout) const {
    return m_vkCreateDescriptorSetLayout(m_device, pCreateInfo, nullptr, pSetLayout);
}

VkResult ContextTable::vkCreateDescriptorUpdateTemplate(const VkDescriptorUpdateTemplateCreateInfo *pCreateInfo, VkDescriptorUpdateTemplate *pDescriptorUpdateTemplate) const {
    return m_vkCreateDescriptorUpdateTemplate(m_device, pCreateInfo, nullptr, pDescriptorUpdateTemplate);
}

VkResult ContextTable::vkCreateDevice(const VkDeviceCreateInfo *pCreateInfo, VkDevice *pDevice) const {
    return m_vkCreateDevice(m_physical_device, pCreateInfo, nullptr, pDevice);
}

VkResult ContextTable::vkCreateEvent(const VkEventCreateInfo *pCreateInfo, VkEvent *pEvent) const {
    return m_vkCreateEvent(m_device, pCreateInfo, nullptr, pEvent);
}

VkResult ContextTable::vkCreateFence(const VkFenceCreateInfo *pCreateInfo, VkFence *pFence) const {
    return m_vkCreateFence(m_device, pCreateInfo, nullptr, pFence);
}

VkResult ContextTable::vkCreateFramebuffer(const VkFramebufferCreateInfo *pCreateInfo, VkFramebuffer *pFramebuffer) const {
    return m_vkCreateFramebuffer(m_device, pCreateInfo, nullptr, pFramebuffer);
}

VkResult ContextTable::vkCreateGraphicsPipelines(VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkGraphicsPipelineCreateInfo *pCreateInfos, VkPipeline *pPipelines) const {
    return m_vkCreateGraphicsPipelines(m_device, pipelineCache, createInfoCount, pCreateInfos, nullptr, pPipelines);
}

VkResult ContextTable::vkCreateImage(const VkImageCreateInfo *pCreateInfo, VkImage *pImage) const {
    return m_vkCreateImage(m_device, pCreateInfo, nullptr, pImage);
}

VkResult ContextTable::vkCreateImageView(const VkImageViewCreateInfo *pCreateInfo, VkImageView *pView) const {
    return m_vkCreateImageView(m_device, pCreateInfo, nullptr, pView);
}

VkResult ContextTable::vkCreateInstance(const VkInstanceCreateInfo *pCreateInfo, VkInstance *pInstance) const {
    return m_vkCreateInstance(pCreateInfo, nullptr, pInstance);
}

VkResult ContextTable::vkCreatePipelineCache(const VkPipelineCacheCreateInfo *pCreateInfo, VkPipelineCache *pPipelineCache) const {
    return m_vkCreatePipelineCache(m_device, pCreateInfo, nullptr, pPipelineCache);
}

VkResult ContextTable::vkCreatePipelineLayout(const VkPipelineLayoutCreateInfo *pCreateInfo, VkPipelineLayout *pPipelineLayout) const {
    return m_vkCreatePipelineLayout(m_device, pCreateInfo, nullptr, pPipelineLayout);
}

VkResult ContextTable::vkCreateQueryPool(const VkQueryPoolCreateInfo *pCreateInfo, VkQueryPool *pQueryPool) const {
    return m_vkCreateQueryPool(m_device, pCreateInfo, nullptr, pQueryPool);
}

VkResult ContextTable::vkCreateRenderPass(const VkRenderPassCreateInfo *pCreateInfo, VkRenderPass *pRenderPass) const {
    return m_vkCreateRenderPass(m_device, pCreateInfo, nullptr, pRenderPass);
}

VkResult ContextTable::vkCreateRenderPass2(const VkRenderPassCreateInfo2 *pCreateInfo, VkRenderPass *pRenderPass) const {
    return m_vkCreateRenderPass2(m_device, pCreateInfo, nullptr, pRenderPass);
}

VkResult ContextTable::vkCreateSampler(const VkSamplerCreateInfo *pCreateInfo, VkSampler *pSampler) const {
    return m_vkCreateSampler(m_device, pCreateInfo, nullptr, pSampler);
}

VkResult ContextTable::vkCreateSamplerYcbcrConversion(const VkSamplerYcbcrConversionCreateInfo *pCreateInfo, VkSamplerYcbcrConversion *pYcbcrConversion) const {
    return m_vkCreateSamplerYcbcrConversion(m_device, pCreateInfo, nullptr, pYcbcrConversion);
}

VkResult ContextTable::vkCreateSemaphore(const VkSemaphoreCreateInfo *pCreateInfo, VkSemaphore *pSemaphore) const {
    return m_vkCreateSemaphore(m_device, pCreateInfo, nullptr, pSemaphore);
}

VkResult ContextTable::vkCreateShaderModule(const VkShaderModuleCreateInfo *pCreateInfo, VkShaderModule *pShaderModule) const {
    return m_vkCreateShaderModule(m_device, pCreateInfo, nullptr, pShaderModule);
}

VkResult ContextTable::vkCreateSwapchainKHR(const VkSwapchainCreateInfoKHR *pCreateInfo, VkSwapchainKHR *pSwapchain) const {
    return m_vkCreateSwapchainKHR(m_device, pCreateInfo, nullptr, pSwapchain);
}

VkResult ContextTable::vkCreateXcbSurfaceKHR(const VkXcbSurfaceCreateInfoKHR *pCreateInfo, VkSurfaceKHR *pSurface) const {
    return m_vkCreateXcbSurfaceKHR(m_instance, pCreateInfo, nullptr, pSurface);
}

void ContextTable::vkDestroyBuffer(VkBuffer buffer) const {
    return m_vkDestroyBuffer(m_device, buffer, nullptr);
}

void ContextTable::vkDestroyBufferView(VkBufferView bufferView) const {
    return m_vkDestroyBufferView(m_device, bufferView, nullptr);
}

void ContextTable::vkDestroyCommandPool(VkCommandPool commandPool) const {
    return m_vkDestroyCommandPool(m_device, commandPool, nullptr);
}

void ContextTable::vkDestroyDescriptorPool(VkDescriptorPool descriptorPool) const {
    return m_vkDestroyDescriptorPool(m_device, descriptorPool, nullptr);
}

void ContextTable::vkDestroyDescriptorSetLayout(VkDescriptorSetLayout descriptorSetLayout) const {
    return m_vkDestroyDescriptorSetLayout(m_device, descriptorSetLayout, nullptr);
}

void ContextTable::vkDestroyDescriptorUpdateTemplate(VkDescriptorUpdateTemplate descriptorUpdateTemplate) const {
...
void ContextTable::vkDestroyEvent(VkEvent event) const {
    return m_vkDestroyEvent(m_device, event, nullptr);
}

void ContextTable::vkDestroyFence(VkFence fence) const {
    return m_vkDestroyFence(m_device, fence, nullptr);
}

void ContextTable::vkDestroyFramebuffer(VkFramebuffer framebuffer) const {
    return m_vkDestroyFramebuffer(m_device, framebuffer, nullptr);
}

void ContextTable::vkDestroyImage(VkImage image) const {
    return m_vkDestroyImage(m_device, image, nullptr);
}

void ContextTable::vkDestroyImageView(VkImageView imageView) const {
...
void ContextTable::vkDestroyPipeline(VkPipeline pipeline) const {
    return m_vkDestroyPipeline(m_device, pipeline, nullptr);
}

void ContextTable::vkDestroyPipelineCache(VkPipelineCache pipelineCache) const {
    return m_vkDestroyPipelineCache(m_device, pipelineCache, nullptr);
}

void ContextTable::vkDestroyPipelineLayout(VkPipelineLayout pipelineLayout) const {
    return m_vkDestroyPipelineLayout(m_device, pipelineLayout, nullptr);
}

void ContextTable::vkDestroyQueryPool(VkQueryPool queryPool) const {
    return m_vkDestroyQueryPool(m_device, queryPool, nullptr);
}

void ContextTable::vkDestroyRenderPass(VkRenderPass renderPass) const {
    return m_vkDestroyRenderPass(m_device, renderPass, nullptr);
}

void ContextTable::vkDestroySampler(VkSampler sampler) const {
    return m_vkDestroySampler(m_device, sampler, nullptr);
}

void ContextTable::vkDestroySamplerYcbcrConversion(VkSamplerYcbcrConversion ycbcrConversion) const {
    return m_vkDestroySamplerYcbcrConversion(m_device, ycbcrConversion, nullptr);
}

void ContextTable::vkDestroySemaphore(VkSemaphore semaphore) const {
    return m_vkDestroySemaphore(m_device, semaphore, nullptr);
}

void ContextTable::vkDestroyShaderModule(VkShaderModule shaderModule) const {
    return m_vkDestroyShaderModule(m_device, shaderModule, nullptr);
}

void ContextTable::vkDestroySurfaceKHR(VkSurfaceKHR surface) const {
    return m_vkDestroySurfaceKHR(m_instance, surface, nullptr);
}

void ContextTable::vkDestroySwapchainKHR(VkSwapchainKHR swapchain) const {
    return m_vkDestroySwapchainKHR(m_device, swapchain, nullptr);
}

VkResult ContextTable::vkDeviceWaitIdle() const {
    return m_vkDeviceWaitIdle(m_device);
}

VkResult ContextTable::vkEndCommandBuffer(VkCommandBuffer commandBuffer) const {
    return m_vkEndCommandBuffer(commandBuffer);
}

VkResult ContextTable::vkEnumerateDeviceExtensionProperties(const char *pLayerName, uint32_t *pPropertyCount, VkExtensionProperties *pProperties) const {
    return m_vkEnumerateDeviceExtensionProperties(m_physical_device, pLayerName, pPropertyCount, pProperties);
}

VkResult ContextTable::vkEnumerateDeviceLayerProperties(uint32_t *pPropertyCount, VkLayerProperties *pProperties) const {
    return m_vkEnumerateDeviceLayerProperties(m_physical_device, pPropertyCount, pProperties);
}

VkResult ContextTable::vkEnumerateInstanceExtensionProperties(const char *pLayerName, uint32_t *pPropertyCount, VkExtensionProperties *pProperties) const {
    return m_vkEnumerateInstanceExtensionProperties(pLayerName, pPropertyCount, pProperties);
}

VkResult ContextTable::vkEnumerateInstanceLayerProperties(uint32_t *pPropertyCount, VkLayerProperties *pProperties) const {
    return m_vkEnumerateInstanceLayerProperties(pPropertyCount, pProperties);
}

VkResult ContextTable::vkEnumerateInstanceVersion(uint32_t *pApiVersion) const {
    return m_vkEnumerateInstanceVersion(pApiVersion);
}

VkResult ContextTable::vkEnumeratePhysicalDeviceGroups(uint32_t *pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties *pPhysicalDeviceGroupProperties) const {
    return m_vkEnumeratePhysicalDeviceGroups(m_instance, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
}

VkResult ContextTable::vkEnumeratePhysicalDevices(uint32_t *pPhysicalDeviceCount, VkPhysicalDevice *pPhysicalDevices) const {
    return m_vkEnumeratePhysicalDevices(m_instance, pPhysicalDeviceCount, pPhysicalDevices);
}

VkResult ContextTable::vkFlushMappedMemoryRanges(uint32_t memoryRangeCount, const VkMappedMemoryRange *pMemoryRanges) const {
    return m_vkFlushMappedMemoryRanges(m_device, memoryRangeCount, pMemoryRanges);
}

void ContextTable::vkFreeCommandBuffers(VkCommandPool commandPool, uint32_t commandBufferCount, const VkCommandBuffer *pCommandBuffers) const {
    return m_vkFreeCommandBuffers(m_device, commandPool, commandBufferCount, pCommandBuffers);
}

VkResult ContextTable::vkFreeDescriptorSets(VkDescriptorPool descriptorPool, uint32_t descriptorSetCount, const VkDescriptorSet *pDescriptorSets) const {
    return m_vkFreeDescriptorSets(m_device, descriptorPool, descriptorSetCount, pDescriptorSets);
}

void ContextTable::vkFreeMemory(VkDeviceMemory memory) const {
    return m_vkFreeMemory(m_device, memory, nullptr);
}

VkDeviceAddress ContextTable::vkGetBufferDeviceAddress(const VkBufferDeviceAddressInfo *pInfo) const {
    return m_vkGetBufferDeviceAddress(m_device, pInfo);
}

void ContextTable::vkGetBufferMemoryRequirements(VkBuffer buffer, VkMemoryRequirements *pMemoryRequirements) const {
    return m_vkGetBufferMemoryRequirements(m_device, buffer, pMemoryRequirements);
}

void ContextTable::vkGetBufferMemoryRequirements2(const VkBufferMemoryRequirementsInfo2 *pInfo, VkMemoryRequirements2 *pMemoryRequirements) const {
    return m_vkGetBufferMemoryRequirements2(m_device, pInfo, pMemoryRequirements);
}

uint64_t ContextTable::vkGetBufferOpaqueCaptureAddress(const VkBufferDeviceAddressInfo *pInfo) const {
    return m_vkGetBufferOpaqueCaptureAddress(m_device, pInfo);
}

void ContextTable::vkGetDescriptorSetLayoutSupport(const VkDescriptorSetLayoutCreateInfo *pCreateInfo, VkDescriptorSetLayoutSupport *pSupport) const {
    return m_vkGetDescriptorSetLayoutSupport(m_device, pCreateInfo, pSupport);
}

void ContextTable::vkGetDeviceGroupPeerMemoryFeatures(uint32_t heapIndex, uint32_t localDeviceIndex, uint32_t remoteDeviceIndex, VkPeerMemoryFeatureFlags *pPeerMemoryFeatures) const {
    return m_vkGetDeviceGroupPeerMemoryFeatures(m_device, heapIndex, localDeviceIndex, remoteDeviceIndex, pPeerMemoryFeatures);
}

VkResult ContextTable::vkGetDeviceGroupPresentCapabilitiesKHR(VkDeviceGroupPresentCapabilitiesKHR *pDeviceGroupPresentCapabilities) const {
    return m_vkGetDeviceGroupPresentCapabilitiesKHR(m_device, pDeviceGroupPresentCapabilities);
}

VkResult ContextTable::vkGetDeviceGroupSurfacePresentModesKHR(VkSurfaceKHR surface, VkDeviceGroupPresentModeFlagsKHR *pModes) const {
    return m_vkGetDeviceGroupSurfacePresentModesKHR(m_device, surface, pModes);
}

void ContextTable::vkGetDeviceMemoryCommitment(VkDeviceMemory memory, VkDeviceSize *pCommittedMemoryInBytes) const {
    return m_vkGetDeviceMemoryCommitment(m_device, memory, pCommittedMemoryInBytes);
}

uint64_t ContextTable::vkGetDeviceMemoryOpaqueCaptureAddress(const VkDeviceMemoryOpaqueCaptureAddressInfo *pInfo) const {
...
void ContextTable::vkGetDeviceQueue(uint32_t queueFamilyIndex, uint32_t queueIndex, VkQueue *pQueue) const {
    return m_vkGetDeviceQueue(m_device, queueFamilyIndex, queueIndex, pQueue);
}

void ContextTable::vkGetDeviceQueue2(const VkDeviceQueueInfo2 *pQueueInfo, VkQueue *pQueue) const {
    return m_vkGetDeviceQueue2(m_device, pQueueInfo, pQueue);
}

VkResult ContextTable::vkGetEventStatus(VkEvent event) const {
    return m_vkGetEventStatus(m_device, event);
}

VkResult ContextTable::vkGetFenceStatus(VkFence fence) const {
    return m_vkGetFenceStatus(m_device, fence);
}

void ContextTable::vkGetImageMemoryRequirements(VkImage image, VkMemoryRequirements *pMemoryRequirements) const {
    return m_vkGetImageMemoryRequirements(m_device, image, pMemoryRequirements);
}

void ContextTable::vkGetImageMemoryRequirements2(const VkImageMemoryRequirementsInfo2 *pInfo, VkMemoryRequirements2 *pMemoryRequirements) const {
    return m_vkGetImageMemoryRequirements2(m_device, pInfo, pMemoryRequirements);
}

void ContextTable::vkGetImageSparseMemoryRequirements(VkImage image, uint32_t *pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements *pSparseMemoryRequirements) const {
    return m_vkGetImageSparseMemoryRequirements(m_device, image, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
}

void ContextTable::vkGetImageSparseMemoryRequirements2(const VkImageSparseMemoryRequirementsInfo2 *pInfo, uint32_t *pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2 *pSparseMemoryRequirements) const {
    return m_vkGetImageSparseMemoryRequirements2(m_device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
}

void ContextTable::vkGetImageSubresourceLayout(VkImage image, const VkImageSubresource *pSubresource, VkSubresourceLayout *pLayout) const {
    return m_vkGetImageSubresourceLayout(m_device, image, pSubresource, pLayout);
}

void ContextTable::vkGetPhysicalDeviceExternalBufferProperties(const VkPhysicalDeviceExternalBufferInfo *pExternalBufferInfo, VkExternalBufferProperties *pExternalBufferProperties) const {
    return m_vkGetPhysicalDeviceExternalBufferProperties(m_physical_device, pExternalBufferInfo, pExternalBufferProperties);
}

void ContextTable::vkGetPhysicalDeviceExternalFenceProperties(const VkPhysicalDeviceExternalFenceInfo *pExternalFenceInfo, VkExternalFenceProperties *pExternalFenceProperties) const {
    return m_vkGetPhysicalDeviceExternalFenceProperties(m_physical_device, pExternalFenceInfo, pExternalFenceProperties);
}

void ContextTable::vkGetPhysicalDeviceExternalSemaphoreProperties(const VkPhysicalDeviceExternalSemaphoreInfo *pExternalSemaphoreInfo, VkExternalSemaphoreProperties *pExternalSemaphoreProperties) const {
...
void ContextTable::vkGetPhysicalDeviceFeatures(VkPhysicalDeviceFeatures *pFeatures) const {
    return m_vkGetPhysicalDeviceFeatures(m_physical_device, pFeatures);
}

void ContextTable::vkGetPhysicalDeviceFeatures2(VkPhysicalDeviceFeatures2 *pFeatures) const {
    return m_vkGetPhysicalDeviceFeatures2(m_physical_device, pFeatures);
}

void ContextTable::vkGetPhysicalDeviceFeatures2KHR(VkPhysicalDeviceFeatures2 *pFeatures) const {
    return m_vkGetPhysicalDeviceFeatures2KHR(m_physical_device, pFeatures);
}

void ContextTable::vkGetPhysicalDeviceFormatProperties(VkFormat format, VkFormatProperties *pFormatProperties) const {
    return m_vkGetPhysicalDeviceFormatProperties(m_physical_device, format, pFormatProperties);
}

void ContextTable::vkGetPhysicalDeviceFormatProperties2(VkFormat format, VkFormatProperties2 *pFormatProperties) const {
    return m_vkGetPhysicalDeviceFormatProperties2(m_physical_device, format, pFormatProperties);
}

void ContextTable::vkGetPhysicalDeviceFormatProperties2KHR(VkFormat format, VkFormatProperties2 *pFormatProperties) const {
    return m_vkGetPhysicalDeviceFormatProperties2KHR(m_physical_device, format, pFormatProperties);
}

VkResult ContextTable::vkGetPhysicalDeviceImageFormatProperties(VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlags usage, VkImageCreateFlags flags, VkImageFormatProperties *pImageFormatProperties) const {
...
VkResult ContextTable::vkGetPhysicalDeviceImageFormatProperties2(const VkPhysicalDeviceImageFormatInfo2 *pImageFormatInfo, VkImageFormatProperties2 *pImageFormatProperties) const {
    return m_vkGetPhysicalDeviceImageFormatProperties2(m_physical_device, pImageFormatInfo, pImageFormatProperties);
}

VkResult ContextTable::vkGetPhysicalDeviceImageFormatProperties2KHR(const VkPhysicalDeviceImageFormatInfo2 *pImageFormatInfo, VkImageFormatProperties2 *pImageFormatProperties) const {
    return m_vkGetPhysicalDeviceImageFormatProperties2KHR(m_physical_device, pImageFormatInfo, pImageFormatProperties);
}

void ContextTable::vkGetPhysicalDeviceMemoryProperties(VkPhysicalDeviceMemoryProperties *pMemoryProperties) const {
    return m_vkGetPhysicalDeviceMemoryProperties(m_physical_device, pMemoryProperties);
}

void ContextTable::vkGetPhysicalDeviceMemoryProperties2(VkPhysicalDeviceMemoryProperties2 *pMemoryProperties) const {
    return m_vkGetPhysicalDeviceMemoryProperties2(m_physical_device, pMemoryProperties);
}

void ContextTable::vkGetPhysicalDeviceMemoryProperties2KHR(VkPhysicalDeviceMemoryProperties2 *pMemoryProperties) const {
    return m_vkGetPhysicalDeviceMemoryProperties2KHR(m_physical_device, pMemoryProperties);
}

VkResult ContextTable::vkGetPhysicalDevicePresentRectanglesKHR(VkSurfaceKHR surface, uint32_t *pRectCount, VkRect2D *pRects) const {
    return m_vkGetPhysicalDevicePresentRectanglesKHR(m_physical_device, surface, pRectCount, pRects);
}

void ContextTable::vkGetPhysicalDeviceProperties(VkPhysicalDeviceProperties *pProperties) const {
    return m_vkGetPhysicalDeviceProperties(m_physical_device, pProperties);
}

void ContextTable::vkGetPhysicalDeviceProperties2(VkPhysicalDeviceProperties2 *pProperties) const {
    return m_vkGetPhysicalDeviceProperties2(m_physical_device, pProperties);
}

void ContextTable::vkGetPhysicalDeviceProperties2KHR(VkPhysicalDeviceProperties2 *pProperties) const {
    return m_vkGetPhysicalDeviceProperties2KHR(m_physical_device, pProperties);
}

void ContextTable::vkGetPhysicalDeviceQueueFamilyProperties(uint32_t *pQueueFamilyPropertyCount, VkQueueFamilyProperties *pQueueFamilyProperties) const {
    return m_vkGetPhysicalDeviceQueueFamilyProperties(m_physical_device, pQueueFamilyPropertyCount, pQueueFamilyProperties);
}

void ContextTable::vkGetPhysicalDeviceQueueFamilyProperties2(uint32_t *pQueueFamilyPropertyCount, VkQueueFamilyProperties2 *pQueueFamilyProperties) const {
    return m_vkGetPhysicalDeviceQueueFamilyProperties2(m_physical_device, pQueueFamilyPropertyCount, pQueueFamilyProperties);
}

void ContextTable::vkGetPhysicalDeviceQueueFamilyProperties2KHR(uint32_t *pQueueFamilyPropertyCount, VkQueueFamilyProperties2 *pQueueFamilyProperties) const {
    return m_vkGetPhysicalDeviceQueueFamilyProperties2KHR(m_physical_device, pQueueFamilyPropertyCount, pQueueFamilyProperties);
}

void ContextTable::vkGetPhysicalDeviceSparseImageFormatProperties(VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlags usage, VkImageTiling tiling, uint32_t *pPropertyCount, VkSparseImageFormatProperties *pProperties) const {
...
void ContextTable::vkGetPhysicalDeviceSparseImageFormatProperties2(const VkPhysicalDeviceSparseImageFormatInfo2 *pFormatInfo, uint32_t *pPropertyCount, VkSparseImageFormatProperties2 *pProperties) const {
    return m_vkGetPhysicalDeviceSparseImageFormatProperties2(m_physical_device, pFormatInfo, pPropertyCount, pProperties);
}

void ContextTable::vkGetPhysicalDeviceSparseImageFormatProperties2KHR(const VkPhysicalDeviceSparseImageFormatInfo2 *pFormatInfo, uint32_t *pPropertyCount, VkSparseImageFormatProperties2 *pProperties) const {
    return m_vkGetPhysicalDeviceSparseImageFormatProperties2KHR(m_physical_device, pFormatInfo, pPropertyCount, pProperties);
}

VkResult ContextTable::vkGetPhysicalDeviceSurfaceCapabilitiesKHR(VkSurfaceKHR surface, VkSurfaceCapabilitiesKHR *pSurfaceCapabilities) const {
    return m_vkGetPhysicalDeviceSurfaceCapabilitiesKHR(m_physical_device, surface, pSurfaceCapabilities);
}

VkResult ContextTable::vkGetPhysicalDeviceSurfaceFormatsKHR(VkSurfaceKHR surface, uint32_t *pSurfaceFormatCount, VkSurfaceFormatKHR *pSurfaceFormats) const {
    return m_vkGetPhysicalDeviceSurfaceFormatsKHR(m_physical_device, surface, pSurfaceFormatCount, pSurfaceFormats);
}

VkResult ContextTable::vkGetPhysicalDeviceSurfacePresentModesKHR(VkSurfaceKHR surface, uint32_t *pPresentModeCount, VkPresentModeKHR *pPresentModes) const {
    return m_vkGetPhysicalDeviceSurfacePresentModesKHR(m_physical_device, surface, pPresentModeCount, pPresentModes);
}

VkResult ContextTable::vkGetPhysicalDeviceSurfaceSupportKHR(uint32_t queueFamilyIndex, VkSurfaceKHR surface, VkBool32 *pSupported) const {
    return m_vkGetPhysicalDeviceSurfaceSupportKHR(m_physical_device, queueFamilyIndex, surface, pSupported);
}

VkBool32 ContextTable::vkGetPhysicalDeviceXcbPresentationSupportKHR(uint32_t queueFamilyIndex, xcb_connection_t *connection, xcb_visualid_t visual_id) const {
    return m_vkGetPhysicalDeviceXcbPresentationSupportKHR(m_physical_device, queueFamilyIndex, connection, visual_id);
}

VkResult ContextTable::vkGetPipelineCacheData(VkPipelineCache pipelineCache, size_t *pDataSize, void *pData) const {
    return m_vkGetPipelineCacheData(m_device, pipelineCache, pDataSize, pData);
}

VkResult ContextTable::vkGetQueryPoolResults(VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, size_t dataSize, void *pData, VkDeviceSize stride, VkQueryResultFlags flags) const {
    return m_vkGetQueryPoolResults(m_device, queryPool, firstQuery, queryCount, dataSize, pData, stride, flags);
}

void ContextTable::vkGetRenderAreaGranularity(VkRenderPass renderPass, VkExtent2D *pGranularity) const {
    return m_vkGetRenderAreaGranularity(m_device, renderPass, pGranularity);
}

VkResult ContextTable::vkGetSemaphoreCounterValue(VkSemaphore semaphore, uint64_t *pValue) const {
    return m_vkGetSemaphoreCounterValue(m_device, semaphore, pValue);
}

VkResult ContextTable::vkGetSwapchainImagesKHR(VkSwapchainKHR swapchain, uint32_t *pSwapchainImageCount, VkImage *pSwapchainImages) const {
    return m_vkGetSwapchainImagesKHR(m_device, swapchain, pSwapchainImageCount, pSwapchainImages);
}

VkResult ContextTable::vkInvalidateMappedMemoryRanges(uint32_t memoryRangeCount, const VkMappedMemoryRange *pMemoryRanges) const {
    return m_vkInvalidateMappedMemoryRanges(m_device, memoryRangeCount, pMemoryRanges);
}

VkResult ContextTable::vkMapMemory(VkDeviceMemory memory, VkDeviceSize offset, VkDeviceSize size, VkMemoryMapFlags flags, void ** ppData) const {
    return m_vkMapMemory(m_device, memory, offset, size, flags, ppData);
}

VkResult ContextTable::vkMergePipelineCaches(VkPipelineCache dstCache, uint32_t srcCacheCount, const VkPipelineCache *pSrcCaches) const {
    return m_vkMergePipelineCaches(m_device, dstCache, srcCacheCount, pSrcCaches);
}

VkResult ContextTable::vkQueueBindSparse(VkQueue queue, uint32_t bindInfoCount, const VkBindSparseInfo *pBindInfo, VkFence fence) const {
    return m_vkQueueBindSparse(queue, bindInfoCount, pBindInfo, fence);
}

VkResult ContextTable::vkQueuePresentKHR(VkQueue queue, const VkPresentInfoKHR *pPresentInfo) const {
    return m_vkQueuePresentKHR(queue, pPresentInfo);
}

VkResult ContextTable::vkQueueSubmit(VkQueue queue, uint32_t submitCount, const VkSubmitInfo *pSubmits, VkFence fence) const {
    return m_vkQueueSubmit(queue, submitCount, pSubmits, fence);
}

VkResult ContextTable::vkQueueWaitIdle(VkQueue queue) const {
    return m_vkQueueWaitIdle(queue);
}

VkResult ContextTable::vkResetCommandBuffer(VkCommandBuffer commandBuffer, VkCommandBufferResetFlags flags) const {
    return m_vkResetCommandBuffer(commandBuffer, flags);
}

VkResult ContextTable::vkResetCommandPool(VkCommandPool commandPool, VkCommandPoolResetFlags flags) const {
    return m_vkResetCommandPool(m_device, commandPool, flags);
}

VkResult ContextTable::vkResetDescriptorPool(VkDescriptorPool descriptorPool, VkDescriptorPoolResetFlags flags) const {
    return m_vkResetDescriptorPool(m_device, descriptorPool, flags);
}

VkResult ContextTable::vkResetEvent(VkEvent event) const {
    return m_vkResetEvent(m_device, event);
}

VkResult ContextTable::vkResetFences(uint32_t fenceCount, const VkFence *pFences) const {
    return m_vkResetFences(m_device, fenceCount, pFences);
}

void ContextTable::vkResetQueryPool(VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount) const {
    return m_vkResetQueryPool(m_device, queryPool, firstQuery, queryCount);
}

VkResult ContextTable::vkSetEvent(VkEvent event) const {
    return m_vkSetEvent(m_device, event);
}

VkResult ContextTable::vkSignalSemaphore(const VkSemaphoreSignalInfo *pSignalInfo) const {
    return m_vkSignalSemaphore(m_device, pSignalInfo);
}

void ContextTable::vkTrimCommandPool(VkCommandPool commandPool, VkCommandPoolTrimFlags flags) const {
    return m_vkTrimCommandPool(m_device, commandPool, flags);
}

void ContextTable::vkUnmapMemory(VkDeviceMemory memory) const {
    return m_vkUnmapMemory(m_device, memory);
}

void ContextTable::vkUpdateDescriptorSetWithTemplate(VkDescriptorSet descriptorSet, VkDescriptorUpdateTemplate descriptorUpdateTemplate, const void *pData) const {
    return m_vkUpdateDescriptorSetWithTemplate(m_device, descriptorSet, descriptorUpdateTemplate, pData);
}

void ContextTable::vkUpdateDescriptorSets(uint32_t descriptorWriteCount, const VkWriteDescriptorSet *pDescriptorWrites, uint32_t descriptorCopyCount, const VkCopyDescriptorSet *pDescriptorCopies) const {
    return m_vkUpdateDescriptorSets(m_device, descriptorWriteCount, pDescriptorWrites, descriptorCopyCount, pDescriptorCopies);
}

VkResult ContextTable::vkWaitForFences(uint32_t fenceCount, const VkFence *pFences, VkBool32 waitAll, uint64_t timeout) const {
    return m_vkWaitForFences(m_device, fenceCount, pFences, waitAll, timeout);
}

VkResult ContextTable::vkWaitSemaphores(const VkSemaphoreWaitInfo *pWaitInfo, uint64_t timeout) const {
